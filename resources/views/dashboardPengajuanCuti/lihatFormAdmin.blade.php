    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
        ...
        <table>
            ...
            <tr>
                ...
                <td width="24%" rowspan="3" style="text-align: center;">{{ $pengajuanCuti->alamat_cuti }} </td>         
                <td height="100px" style="text-align: center;"><img src="{{ asset('file/' . $pegawai->ttd) }}" alt="Deskripsi Gambar" class="ukuran-gambar">
                    <br><br> ({{ $pegawai->nama }})
                    <br> NIP.({{ $pegawai->NIP }})
                </td>
