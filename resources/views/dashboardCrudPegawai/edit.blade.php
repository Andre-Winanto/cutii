            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" action="{{ url('dashboard/datapegawai/' . $pegawai->id) }}"
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select class="shadow-none @error('nama_kelompok') is-invalid @enderror"
                                            ...
                                            @foreach ($kelompoks as $kelompok)
                                                @if ($kelompok->nama_kelompok == $pegawai->nama_kelompok)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('golongan') is-invalid @enderror"
                                            name="golongan" value="{{ old('golongan', $pegawai->golongan) }}"
                                            id="golongan" placeholder="Golongan" />
                                        @error('golongan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                            name="no_hp" value="{{ old('no_hp', $pegawai->no_hp) }}" id="no_hp"
                        ...
                        {{-- <form class="form-horizontal" action="{{ url('datapegawai/' . $pegawai->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="NIP"
                                        class="col-sm-3 text-end control-label col-form-label">NIP</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('NIP') is-invalid @enderror"
                                            name="NIP" value="{{ old('NIP', $pegawai->NIP) }}" id="NIP"
                                            placeholder="Masukan NIP" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                            ...
                                            value="{{ old('password', $pegawai->password) }}" id="password"
                                            placeholder="Masukan Masa Kerja" step="any" />
                                        @error('password')
                                            <div class="invalid-feedback">
                                                {{ $message }}
